    ...
    if user_data:
        ...
        return {
            ...
            "data": {
                "User ID": user_data.auditly_user_id,
                "User Name": user_data.auditly_user_name,
                "User Type": [_key for _key, _value in user_type_flags.items() if _value == 1],
                "is_admin": user_data.is_admin,
                "is_reports_user": user_data.is_reports_user,
                "is_inpection_user": user_data.is_inspection_user,
