  ...
  const filteredReturnData = useMemo(() => {
    return returnData.filter((data) => {
      const matchesRmaNumber = searchFilters.rmaNumber === "" || 
        data.rma_number.toLowerCase().includes(searchFilters.rmaNumber.toLowerCase());
      ...
      const matchesCustomerName = searchFilters.customerName === "" ||
        data.customer_name.toLowerCase().includes(searchFilters.customerName.toLowerCase());
      ...
      const matchesSalesOrder = searchFilters.salesOrder === "" ||
        data.sales_order.toLowerCase().includes(searchFilters.salesOrder.toLowerCase());
      ...
      if (searchFilters.dateRange.start && searchFilters.dateRange.end) {
        ...
        const dateField = searchFilters.dateType === 'returned' ? 'return_date' : 
                         searchFilters.dateType === 'purchased' ? 'purchased' :
                         searchFilters.dateType === 'shipped' ? 'shipped' : 'delivered';
