...
import axios from "axios";
import { motion, AnimatePresence } from "framer-motion";
import { Search, Filter, Loader2, ClipboardList, PackageCheck, AlertCircle, MapPin, ChevronDown } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Track and manage customer return information
          </motion.p>
        </motion.div>
          ...
          {isLoading ? (
            ...
            >
              <div className="p-6">
                ...
                <div className="overflow-hidden rounded-xl border border-blue-100 mt-6">
                  <div className="overflow-x-auto">
