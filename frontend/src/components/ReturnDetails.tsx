...
interface SearchFilters {
  ...
  dateType: 'purchased' | 'shipped' | 'delivered' | 'return_created';
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="return_created">Return Created Date</option>
              </select>
            </div>
  ...
  const filteredReturnData = useMemo(() => {
    return returnData.filter((data) => {
      ...
      const matchesSalesOrder = searchFilters.salesOrderNumber === "" ||
        data.original_sales_order_number.toLowerCase().includes(searchFilters.salesOrderNumber.toLowerCase());
      ...
      if (searchFilters.dateRange.start && searchFilters.dateRange.end) {
        ...
        const dateField = searchFilters.dateType === 'return_created' 
          ? 'return_created_date' 
          : `date_${searchFilters.dateType}`;
        const dateToCheck = new Date(data[dateField]);

        matchesDateRange = dateToCheck >= startDate && dateToCheck <= endDate;
      }

      return matchesReturnOrder && 
