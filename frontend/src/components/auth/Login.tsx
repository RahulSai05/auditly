...
const Login = () => {
  ...
  const [otpSent, setOtpSent] = useState<boolean>(false); // Track OTP step
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.message === "Invalid User Name or otp") {
    ...
    >
      <div className="w-full max-w-md">
        ...
        >
          ...
          {!otpSent ? (
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 text-white py-3 rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-700"
              >
            ...
            <form onSubmit={handleOtpSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  <Key className="absolute left-3 top-3.5 text-gray-400" />
                  <input
                    type="text"
                    value={otp}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-green-600 text-white py-3 rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-green-700"
              >
          ...
          <AnimatePresence>
            {message.text && (
              <motion.div className={`mt-6 p-4 rounded-lg ${message.type === "success" ? "bg-green-50 text-green-800" : "bg-red-50 text-red-800"}`}>
                <p>{message.text}</p>
              </motion.div>
            )}
          </AnimatePresence>
