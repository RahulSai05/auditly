            ...
            <motion.li variants={itemVariants}>
              ...
              <AnimatePresence>
                {settingsOpen && (
                  ...
                  <motion.li variants={itemVariants}>
                    <NavLink
                      to="/admin/settings/delivery-settings"
                      className={({ isActive }) =>
                        `${nestedLinkStyle} ${isActive ? activeLinkStyle : ""}`
                      }
                      onClick={handleLinkClick}
...
{isInspectionUser && isAgent && approvedAgentId && approvedAgentId !== "null" && (
  <motion.li variants={itemVariants}>
    ...
    >
      ...
      <span className="flex-1 text-left">Agent Dashboard</span>
      <motion.div
...
{isInspectionUser && isManager && approvedManagerId && approvedManagerId !== "null" && (
  <motion.li variants={itemVariants}>
    ...
    >
      ...
      <span className="flex-1 text-left">Manager Dashboard</span>
      <motion.div
        animate={{ rotate: managerOpen ? 90 : 0 }}
        transition={{ duration: 0.3, type: "spring", stiffness: 300 }}
      >
        <ChevronRight className="w-4 h-4" />
      </motion.div>
