...
//               className={`${baseLinkStyle} w-full text-red-600 hover:bg-red-100 hover:text-red-700`}
//             >
        ...
        <ul className="space-y-2 p-5 flex-1">
          ...
          <li>
            ...
            >
                ...
                <div>
                  {connectorsOpen && (
                    <div className="ml-5">
                      <li>
                        <NavLink
                          to="/admin/reports/customer-serials/inbound"
                          className={({ isActive }) =>
                            `${nestedLinkStyle} ${
                              isActive ? activeLinkStyle : ""
                            }`
                      ...
                      <li>
                        <NavLink
                          to="/admin/reports/customer-serials/outbound"
                          className={({ isActive }) =>
                            `${nestedLinkStyle} ${
                              isActive ? activeLinkStyle : ""
                            }`
              ...
              <li>
                <NavLink
                  to="/admin/settings/email-configurations"
                  className={({ isActive }) =>
                    `${nestedLinkStyle} ${isActive ? activeLinkStyle : ""}`
                  }
                  onClick={handleLinkClick}
              ...
              <li>
                <NavLink
                  to="/admin/settings/users-maintenance"
                  className={({ isActive }) =>
                    `${nestedLinkStyle} ${isActive ? activeLinkStyle : ""}`
                  }
                  onClick={handleLinkClick}
          ...
          <li>
            ...
            >
              <li>
                <NavLink
                  to="/admin/maintenance/item-master-upload"
                  className={({ isActive }) =>
                    `${nestedLinkStyle} ${isActive ? activeLinkStyle : ""}`
                  }
                  onClick={handleLinkClick}
              ...
              <li>
                <NavLink
                  to="/admin/maintenance/customer-serial-upload"
                  className={({ isActive }) =>
                    `${nestedLinkStyle} ${isActive ? activeLinkStyle : ""}`
                  }
                  onClick={handleLinkClick}
              ...
              <li>
                <NavLink
                  to="/admin/maintenance/item-image-upload"
                  className={({ isActive }) =>
                    `${nestedLinkStyle} ${isActive ? activeLinkStyle : ""}`
                  }
                  onClick={handleLinkClick}
              ...
              <li>
                <NavLink
                  to="/admin/maintenance/return-upload"
                  className={({ isActive }) =>
                    `${nestedLinkStyle} ${isActive ? activeLinkStyle : ""}`
                  }
                  onClick={handleLinkClick}
