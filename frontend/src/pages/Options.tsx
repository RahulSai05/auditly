...
const Options = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 p-6">
      ...
      <div className="grid md:flex gap-6">
        {/* Quick Scan Option */}
        <div className="w-full md:w-[390px] border border-gray-300 p-6 hover:border-blue-600 bg-[#F9FAFB] shadow-2xl rounded-lg flex flex-col items-center text-center transition-colors">
          <ScanQrCode size={90} className="text-current" />
          <h3 className="text-gray-800 text-xl my-5">Quick Scan</h3>
          <p className="text-gray-800 mb-4">
            Quickly scan your system with an automated scan
          ...
          <button
            onClick={() => router("/auto/scan")}
            className="mt-auto bg-transparent border border-blue-600 hover:bg-blue-600 hover:text-white px-4 py-2 rounded-lg transition-colors"
          >
            Proceed with Quick Scan
          </button>
        </div>
