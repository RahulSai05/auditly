...
interface RoutingModes {
  pickup: number | null; // 0 = Auto, 1 = Manual
  delivery: number | null; // 0 = Auto, 1 = Manual
}
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <motion.button
                ...
                disabled={loading || !isLastWorkingDay || 
                  (routingModes.pickup === null || routingModes.delivery === null)}
                className={`w-full mt-4 py-2 rounded-lg flex items-center justify-center gap-2 ${
                  loading
                    ? "bg-blue-200 text-blue-700"
                    : isLastWorkingDay && routingModes.pickup !== null && routingModes.delivery !== null
