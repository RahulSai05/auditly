...
//                         onClick={() => toggleExpand(id, isAgent ? "agent" : "manager", data.servicing_state)}
//                       >
...
//                                 <span>{data.servicing_city}, {data.servicing_state}</span>
//                               </div>
//                               {data.servicing_zip && (
//                                 <div className="text-xs text-slate-500 mt-1">
//                                   {Array.isArray(data.servicing_zip) 
//                                     ? data.servicing_zip.join(", ")
//                                     : data.servicing_zip}
//                                 </div>
//                               )}
//                             </div>
                            ...
                            <div className="p-6 space-y-6">
                              ...
                              {isAgent && (
                                <div>
                                  ...
                                  ) : managerOptions[id]?.length === 0 ? (
                                    <div className="text-center py-8 bg-slate-50 rounded-lg border border-slate-200">
                                      <User className="w-12 h-12 text-slate-400 mx-auto mb-3" />
                                      <p className="text-slate-600">No available managers for {data.servicing_state}</p>
                                    </div>
                                  ) : (
                                    <div className="space-y-4">
                                      {managerOptions[id]?.map((manager) => (
                                        <div key={manager.manager_id} className="p-4 border border-slate-200 rounded-lg bg-white">
                              ...
                              <div className="mt-6 flex justify-end">
                                <button
                                  ...
                                  disabled={isProcessing || (isAgent && selected.length === 0)}
