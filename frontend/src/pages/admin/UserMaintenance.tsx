            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-blue-50 to-blue-100">
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-blue-600">Gender</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-blue-600">Email</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-blue-600">Organization</th> {/* Added */}
                </tr>
              </thead>
              <tbody className="divide-y divide-blue-50">
                <AnimatePresence>
                  {filteredUsers.length > 0 ? (
                    filteredUsers.map((user, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900">{user.email}</td>
                        <td className="px-6 py-4 text-sm text-gray-900">{user.user_company}</td> {/* Added */}
                      </motion.tr>
                    ))
                  ) : (
                    <motion.tr
                      ...
                      exit={{ opacity: 0 }}
                    >
                      <td colSpan={6} className="px-6 py-8 text-center text-gray-500"> {/* Updated colSpan to 6 */}
                        No users found matching your criteria.
                      </td>
                    </motion.tr>
                  )}
