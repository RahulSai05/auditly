...
// //                 <label 
// //                   htmlFor="file-upload" 
// //                   className={`border-2 border-dashed rounded-lg p-4 transition-all duration-200 ${fileName ? 'border-blue-400 bg-blue-50' : 'border-gray-300 hover:border-blue-400'}`}
// //                 >
// //                   {fileName ? (
// //                     <div className="flex items-center justify-between">
// //                       <span className="text-sm text-blue-600">{fileName}</span>
...
// //                     </div>
// //                   ) : (
// //                     <div className="flex flex-col items-center justify-center h-24 cursor-pointer">
// //                       <Upload className="w-8 h-8 text-gray-400 mb-2" />
// //                       <span className="text-sm text-gray-500">Click to upload CSV file</span>
// //                       <span className="text-xs text-gray-400 mt-1">or drag and drop</span>
// //                     </div>
