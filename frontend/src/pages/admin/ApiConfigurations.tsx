...
//                                 <button
//                                   onClick={() => handleCopy(JSON.stringify(endpoint.sampleRequest, null, 2), "Request copied to clipboard!")}
        ...
        <AnimatePresence>
          {notification.message && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 flex items-center gap-2 px-6 py-3 rounded-lg shadow-lg"
              style={{
