                ...
                <div className="mt-4 space-y-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() => handleCopy(tokenData?.customer_user_id || "")}
                        className="p-1 hover:bg-gray-200 rounded"
                        disabled={!tokenData?.customer_user_id}
                      >
                        <Clipboard className="w-4 h-4 text-gray-600" />
                      </button>
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              handleCopy(JSON.stringify(endpoint.sampleRequest, null, 2));
                            }}
                            className="p-2 hover:bg-gray-100 rounded-full"
                          >
                            <Clipboard className="w-4 h-4 text-gray-600" />
                          ...
                          <div className="p-6">
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                <h4 className="font-medium text-gray-900">Sample Request</h4>
                                <button
                                  onClick={() => handleCopy(JSON.stringify(endpoint.sampleRequest, null, 2))}
                                  className="p-1 hover:bg-gray-100 rounded text-sm text-gray-600 flex items-center gap-1"
                                >
                                  <Clipboard className="w-4 h-4" />
                                  Copy
