...
//                   <div className="max-h-[300px] overflow-y-auto scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-transparent hover:scrollbar-thumb-blue-300">
  ...
  const filteredItems = useMemo(() => {
    return items.filter((item) => {
      const matchesItemNumber = searchFilters.itemNumber === "" ||
        String(item.item_number).toLowerCase().includes(searchFilters.itemNumber.toLowerCase());
      ...
      // Add date filtering logic if your items have date fields
