...
interface SearchFilters {
  ...
  category: string;
  configuration: string;
  sortBy: 'item_number' | 'item_description' | 'category' | 'brand' | 'configuration';
  sortOrder: 'asc' | 'desc';
}
...
const DashboardTables: React.FC = () => {
  ...
  const handleSearchChange = useCallback(
    debounce((field: keyof SearchFilters, value: string) => {
  ...
  const uniqueBrands = useMemo(() => 
    Array.from(new Set(items.map((item) => item.brand.brand_name))).sort(), 
    [items]
  );
  ...
  const uniqueConfigurations = useMemo(() => 
    Array.from(new Set(items.map((item) => item.configuration))).sort(),
    [items]
  );
  ...
  const filteredAndSortedItems = useMemo(() => {
    ...
    return filtered.sort((a, b) => {
      ...
      switch (searchFilters.sortBy) {
        case 'item_number':
          compareA = a.item_number;
          compareB = b.item_number;
          break;
        case 'item_description':
          compareA = a.item_description;
          compareB = b.item_description;
          break;
        case 'category':
          compareA = a.category;
          compareB = b.category;
          break;
        case 'configuration':
          compareA = a.configuration;
          compareB = b.configuration;
          break;
        case 'brand':
          compareA = a.brand.brand_name;
          compareB = b.brand.brand_name;
          break;
        default:
          compareA = a.item_number;
          compareB = b.item_number;
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      onClick={() => exportToXLSX(filteredAndSortedItems)}
                      className="px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors"
                    >
                      Export to XLSX
                    </button>
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 bg-white/50 backdrop-blur-sm border-2 border-blue-100 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-300 transition-all duration-300 text-base shadow-sm"
                          value={searchFilters.itemNumber}
                          onChange={(e) => handleSearchChange('itemNumber', e.target.value)}
                        />
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 bg-white/50 backdrop-blur-sm border-2 border-blue-100 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-300 transition-all duration-300 text-base shadow-sm"
                          value={searchFilters.itemDescription}
                          onChange={(e) => handleSearchChange('itemDescription', e.target.value)}
                        />
                      </div>
