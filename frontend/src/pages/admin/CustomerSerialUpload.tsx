  ...
  const handleFileUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post<{
        ...
        `https://auditlyai.com/api/upload-sale-items-csv/${organization}`,
        formData,
        {
                        ...
                        <table className="w-full">
                          <thead className="bg-blue-50/50 sticky top-0">
                            <tr>
                              ...
                              <th className="px-4 py-3 text-left text-xs font-semibold text-blue-600 uppercase tracking-wider">Serial Number</th>
                              <th className="px-4 py-3 text-left text-xs font-semibold text-blue-600 uppercase tracking-wider">Date Shipped</th>
                            </tr>
                          </thead>
