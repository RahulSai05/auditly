...
//         "https://auditlyai.com/api/upload-customer-return-item-data",
//         formData,
//         {
 ...
 * @property {string} shipped_to_person
 * @property {string} return_order_number
 * @property {string} original_sales_order_number
 */
    ...
    try {
      ...
      const filteredResults = response.data.filter((item) => {
        return (
          ...
          item.return_order_number?.toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      setNotification({
        type: filteredResults.length > 0 ? "success" : "error",
        message: filteredResults.length > 0 ? "Results found." : "No matching results found.",
      });
    } catch (error) {
      console.error("Error searching items:", error);
      setNotification({
                      ...
                      <div className="max-h-64 overflow-y-auto">
                        <table className="w-full">
                          <thead className="bg-blue-50/50">
                            <tr>
                              <th className="px-4 py-3 text-left text-xs font-semibold text-blue-600 uppercase">
                                Customer Name
                              </th>
                              <th className="px-4 py-3 text-left text-xs font-semibold text-blue-600 uppercase">
                                Return Order Number
