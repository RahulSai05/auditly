...
//       if (event.data.type === 'AUTH_SUCCESS') {
//         toast.success(event.data.message || 'Authentication successful!', {
//           position: "top-right",
//           autoClose: 5000,
//           hideProgressBar: false,
//           closeOnClick: true,
...
//   // Clean up interval and popup window when component unmounts
//   useEffect(() => {
//     return () => {
...
//       const authUrl = `${source.authEndpoint}?return_url=${returnUrl}`;
...
//         throw new Error("Popup window blocked by browser. Please allow popups for this site.");
//       }
...
//       {/* Loading indicator when auth window is open */}
//       <AnimatePresence>
//         {isAuthWindowOpen && (
//           <motion.div
...
//               <h3 className="text-lg font-medium mb-4">Authenticating with Power BI</h3>
//               <p className="mb-4">Please complete authentication in the popup window</p>
...
//       <div className={`max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 ${isAuthWindowOpen ? 'blur-sm' : ''}`}>
//         {/* Header Section */}
//         <motion.div
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
...
const Inbound: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (message) {
      toast.success(decodeURIComponent(message.replace(/\+/g, ' ')), {
        position: "top-right",
        autoClose: 5000,
      });
      searchParams.delete('message');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className="mb-16">
          <a href="#" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 mb-6">
            <ArrowLeft className="w-5 h-5" />
            <span className="text-lg">Create a new data source</span>
          </a>

          <h1 className="text-5xl font-bold text-gray-900 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-700">
            Data Sources
          </h1>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  {source.authEndpoint && (
                    ...
                    >
                      {loading[source.id] ? 'Connecting...' : 'Connect'}
                    </button>
                  )}
                </div>
              </div>
