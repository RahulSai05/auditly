...
//       const reactivatingEmail = localStorage.getItem('reactivatingEmail');
//       const returnUrl = encodeURIComponent(window.location.origin);
//       let authUrl = `${source.authEndpoint}?mapping_id=${userId}&returnUrl=${returnUrl}&connection_type=inbound`;
      
//       if (reactivatingEmail) {
//         authUrl += `&email=${encodeURIComponent(reactivatingEmail)}`;
//         localStorage.removeItem('reactivatingEmail');
//       }
...
//   const handleReactivateConnection = (source: DataSource, email: string) => {
//     if (!source.authEndpoint) return;
//     localStorage.setItem('reactivatingEmail', email);
//     handleAuthClick(source);
//   };
...
//                                       {activeTab === "inactive" && (
//                                         <button
//                                           onClick={() => handleReactivateConnection(source, user.power_bi_email)}
...
//                                         onClick={() => handleDeleteConnection(user.power_bi_email)}
//                                         className="p-1.5 rounded-full text-red-500 hover:bg-red-50 hover:text-red-600 transition-colors"
//                                         title={activeTab === "active" ? "Remove connection" : "Delete connection"}
//                                       >
//                                         <Trash2 className="w-4 h-4" />
//                                       </button>
//                                     </div>
