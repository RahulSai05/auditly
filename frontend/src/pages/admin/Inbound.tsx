                        ...
                        {source.id === 3 ? (
                          <div className="flex gap-2">
                            <motion.button
                              ...
                              className="px-4 py-2 bg-gradient-to-r from-light-blue-500 to-light-blue-600 text-white text-sm font-medium rounded-lg shadow hover:shadow-md transition-all"
