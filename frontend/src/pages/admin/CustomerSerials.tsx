...
const CustomerSerials: React.FC = () => {
  ...
  const SearchBar = React.memo(({ value, onChange, placeholder, filter, onFilterChange, filterOptions, filterPlaceholder }: { value: string; onChange: (e: React.ChangeEvent) => void; placeholder: string; filter: string; onFilterChange: (e: React.ChangeEvent) => void; filterOptions: string[]; filterPlaceholder: string; }) => (
    <div className="flex items-center gap-3">
      <div className="relative">
        ...
        <input
          ...
          onChange={onChange}
          placeholder={placeholder}
          className="bg-white/50 backdrop-blur-lg rounded-lg border border-blue-50 px-10 py-3 w-64 focus:outline-none focus:border-blue-300 transition-all duration-300"
        />
      </div>
      ...
      <div className="relative">
        ...
        <select
          value={filter}
          onChange={onFilterChange}
          className="bg-white/50 backdrop-blur-lg rounded-lg border border-blue-50 px-10 py-3 w-48 appearance-none focus:outline-none focus:border-blue-300 transition-all duration-300"
        >
          <option value="">{filterPlaceholder}</option>
          {filterOptions.map((option) => (
            <option key={option} value={option}>
        ...
        {isLoading ? (
          ...
          >
            <div className="p-6">
              ...
              <div className="overflow-hidden rounded-xl border border-blue-100 mt-6"> {/* Added margin-top */}
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-blue-100">
                    <thead>
                      <tr>
                    ...
                    <tbody className="divide-y divide-blue-50">
                      {filteredSalesData.map((data) => (
                        <AnimatePresence key={data.SalesOrder}>
                          <motion.tr
                            variants={itemVariants}
                            className="hover:bg-blue-50/50 transition-colors duration-200"
                            whileHover={{ scale: 1.002 }}
                      ...
                      {filteredSalesData.length === 0 && (
                        <tr> {/* Removed AnimatePresence and motion.tr */}
                          <td
                            colSpan={9}
                            className="px-6 py-8 text-center text-gray-500 bg-gray-50/50"
                          >
