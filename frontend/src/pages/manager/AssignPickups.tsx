...
// //       // Update the selected item to show it's unassigned
// //       if (selectedItem) {
// //         setSelectedItem({
// //           ...selectedItem,
...
// //                     {returnItems.length === 0
// //                       ? "There are currently no return pickups pending in your managed region."
// //                       : searchTerm || statusFilter !== "all"
...
// //                               {item.status}
// //                               {item.assigned_agent && (
// //                                 <span className="ml-1">({item.assigned_agent.agent_name})</span>
// //                               )}
// //                             </div>
// //                           </div>
// //                         </div>
...
// //                             {item.status === "Pending Agent Assignment" && !item.assigned_agent ? (
// //                               <div>
...
// //                                                 <MapPin className="w-4 h-4" />
// //                                                 <span>
// //                                                   Serves ZIP: {agent.servicing_zip}
// //                                                 </span>
// //                                               </div>
// //                                               <div className="mt-1 flex gap-2">
// //                                                 <span className="font-medium bg-blue-100 text-blue-800 px-2 py-1 rounded-full">
// //                                                   Sales Orders: {agent.total_sales_orders}
// //                                                 </span>
// //                                                 <span className="font-medium bg-purple-100 text-purple-800 px-2 py-1 rounded-full">
// //                                                   Return Orders: {agent.total_return_orders}
// //                                                 </span>
// //                                               </div>
// //                                             </div>
// //                                           </div>
...
// //                                     {item.assigned_agent 
// //                                       ? `Assigned to ${item.assigned_agent.agent_name}`
// //                                       : "Agent assigned"}
// //                                   </h4>
...
//             {/* Header Section */}
//             <div className="text-center mb-12">
//               <div className="w-20 h-20 bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg hover:shadow-orange-200 transition-all duration-300">
//                 <RotateCcw className="w-10 h-10 text-orange-600" />
//               </div>
//               <h1 className="text-4xl font-bold text-gray-900 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-orange-700">
//                 Return Pickups
//               </h1>
//               <p className="text-xl text-gray-600 max-w-2xl mx-auto">
...
//                   value={statusFilter}
//                   onChange={(e) => setStatusFilter(e.target.value)}
//                   className="px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white"
//                 >
//                   <option value="all">All Statuses</option>
//                   <option value="Pending Agent Assignment">Pending Assignment</option>
//                   <option value="Agent Assigned">Agent Assigned</option>
...
//                   </div>
//                   <div>
//                     <p className="text-sm text-orange-600 font-medium">Total Returns</p>
//                     <p className="text-xl font-semibold text-orange-800">{filteredItems.length}</p>
//                   </div>
//                 </div>
//               </div>
...
//                   </div>
//                   <div>
//                     <p className="text-sm text-blue-600 font-medium">Agent Assigned</p>
//                     <p className="text-xl font-semibold text-blue-800">
//                       {filteredItems.filter(item => item.assigned_agent && item.status !== "Completed").length}
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                         : "border-slate-200 hover:border-orange-200 bg-white hover:shadow-md"
//                     }`}
//                   >
//                     <div
//                       className="p-6 cursor-pointer"
...
//                                         <span className="font-medium">{item.return_carrier}</span>
//                                       </div>
//                                       <div className="flex justify-between">
//                                         <span className="text-slate-500">Destination:</span>
//                                         <span className="font-medium">{item.return_destination}</span>
//                                       </div>
//                                     </div>
//                                   </div>
...
//                                         <span className="font-medium">{formatDate(item.date_purchased)}</span>
//                                       </div>
//                                       <div className="flex justify-between">
//                                         <span className="text-slate-500">Return Created:</span>
//                                         <span className="font-medium">{formatDate(item.return_created_date)}</span>
//                                       </div>
//                                       {item.return_received_date && (
//                                         <div className="flex justify-between">
//                                           <span className="text-slate-500">Received:</span>
//                                           <span className="font-medium">{formatDate(item.return_received_date)}</span>
//                                         </div>
//                                       )}
//                                     </div>
//                                   </div>
...
//                                     {eligibleAgents.map((agent) => (
//                                       <div key={agent.agent_id} className="bg-white p-6 rounded-xl border border-slate-200 hover:border-orange-200 transition-colors">
//                                         <div className="flex justify-between items-start">
//                                           <div className="flex items-start gap-4 flex-1">
...
//                                                     ZIP: <span className="font-medium">{agent.servicing_zip}</span>
//                                                   </span>
//                                                 </div>
...
//                                                   <Package className="w-4 h-4 text-slate-400" />
//                                                   <span className="text-sm text-slate-600">
//                                                     Sales: <span className="font-medium text-blue-600">{agent.total_sales_orders}</span>
//                                                   </span>
//                                                 </div>
...
//                                                   <span className="text-sm text-slate-600">
//                                                     Returns: <span className="font-medium text-orange-600">{agent.total_return_orders}</span>
//                                                   </span>
//                                                 </div>
//                                               </div>
//                                             </div>
...
//                                             disabled={loading}
//                                             className="px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 disabled:opacity-50 flex items-center gap-2 transition-colors ml-4"
//                                           >
