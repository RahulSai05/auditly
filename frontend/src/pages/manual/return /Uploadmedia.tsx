...
export default function UploadMedia() {
  ...
  const inspectionData = useSelector(
    (state: RootState) => state.ids.inspectionData
  );
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div className=" mx-auto p-6 border rounded-md">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="block w-fit text-sm h-6 text-gray-500 border rounded-md cursor-pointer"
          />
        </div>
        <div className="mb-6">
          ...
          <input
            ...
            className="block w-fit text-sm text-gray-500 border rounded-md cursor-pointer"
          />
        </div>
