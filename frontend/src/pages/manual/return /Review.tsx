...
export default function Review() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <ProductDetails />
      {/* Outer White Box */}
      <div className="mt-2 py-0 bg-white shadow-md border border-gray-200 rounded-lg w-full mx-auto">
        <h2 className="text-lg font-semibold bg-gray-100 py-2 text-gray-800 text-center mb-6">
          Review Summary
        </h2>
        ...
        <div className="p-4  rounded-md">
          <div className="grid grid-cols-[200px_1fr] gap-y-4 text-sm">
            ...
            <span className="text-gray-800 font-semibold">
              : {reviewData.uploadMedia}
            </span>
            <span className="text-gray-600 font-medium">
              Product Inspection
            </span>
            <span className="text-gray-800 font-semibold">
              : {reviewData.productInspection}
            </span>
      ...
      {/* Navigation Buttons */}
      <div className="flex justify-end mt-6  w-full mx-auto">
        <button
