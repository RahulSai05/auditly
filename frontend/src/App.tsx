...
import Options from "./pages/Options";
import GetAll from "./pages/manual/GetAll";
import Details from "./pages/manual/return/Details"; // Corrected path
import Inspection from "./pages/manual/return/Inspection"; // Corrected path
import UploadMedia from "./pages/manual/return/UploadMedia"; // Corrected path
import Compare from "./pages/manual/return/Compare"; // Corrected path
import Review from "./pages/manual/return/Review"; // Corrected path
import Done from "./pages/manual/return/Done"; // Corrected path
import Scan from "./pages/auto/Scan";
import Dashboard from "./pages/admin/Dashboard";
import DashboardTables from "./pages/admin/DashboardTables";
import ItemUpload from "./pages/admin/ItemUpload";
