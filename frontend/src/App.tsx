...
const AdminWrapper = () => {
  ...
  return user?.is_admin ? <Outlet /> : <Navigate to="/unauthorized" replace />;
};

const ReportsWrapper = () => {
  const { user } = useSelector((state: RootState) => state.auth);
  return user?.is_reports_user ? <Outlet /> : <Navigate to="/unauthorized" replace />;
};

const InspectionWrapper = () => {
  const { user } = useSelector((state: RootState) => state.auth);
  return user?.is_inpection_user || user?.is_agent ? <Outlet /> : <Navigate to="/unauthorized" replace />;
};
        ...
        <Route element={<AuthWrapper />}>
          ...
          <Route element={<AdminWrapper />}>
            <Route element={<AdminLayout />}>
              ...
              <Route path="/admin/settings/mapping-rules" element={<MappingRules />} />
              <Route path="/admin/settings/api-configurations" element={<ApiConfigurations />} />
              <Route path="/admin/settings/api-endpoint" element={<ApiEndpoint />} />
          ...
          <Route element={<InspectionWrapper />}>
            ...
            {/* Shared Admin+Inspection Routes */}
            <Route element={<AdminLayout />}>
              ...
              <Route path="/admin/agent/schedule" element={<Schedule />} />
              <Route path="/admin/agent/scheduled-deliveries" element={<ScheduledDeliveries />} />
              <Route path="/admin/agent/scheduled-pickups" element={<ScheduledPickups />} />
